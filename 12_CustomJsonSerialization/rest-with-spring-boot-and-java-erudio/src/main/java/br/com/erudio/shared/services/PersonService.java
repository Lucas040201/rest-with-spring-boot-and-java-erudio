...
import br.com.erudio.shared.mapper.custom.PersonMapper;
...
public class PersonService {
    ...
    public PersonVOV2 createV2(PersonVOV2 person) {
        ...
        Person entity = this.personMapper.convertVoToEntity(person);
        PersonVOV2 personVOV2 = this.personMapper.convertEntityToVo(this.personRepository.save(entity));
        return personVOV2;
    }
